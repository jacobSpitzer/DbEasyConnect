...
namespace Bar
{
    public class ExpressionToSQL : ExpressionVisitor
    {
        ...
        public ExpressionToSQL(IQueryable queryable, Expression exp = null)
        {
        ...
        public ExpressionToSQL(Expression expression)
        {
        ...
        protected override Expression VisitMethodCall(MethodCallExpression methodCallExpression)
        {
            switch (methodCallExpression.Method.Name)
            {
                ...
                case nameof(SqlableExtensions.Update):
                    return Visit(methodCallExpression.Arguments[0]);
                ...
                case nameof(SqlableExtensions.PUpdate):
        ...
        {
            var c = body.GetType().GetProperties();
            switch (body)
            {
